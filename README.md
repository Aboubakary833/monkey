...
This repository contains my implementation of the language with little changes I decided to do like supporting all type of number(<i>int, float</i>) and <i>constants</i>.
